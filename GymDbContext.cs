...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.\\SQLEXPRESS;Initial Catalog=gym;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.InvoiceId).HasName("PK__invoice__0CE91F08C36F1A71");

            entity.ToTable("invoice");

            entity.HasIndex(e => e.PaymentsId, "IX_invoice_PAYMENTS_ID");

            entity.HasIndex(e => e.UsersId, "IX_invoice_USERS_ID");
            ...
            entity.HasOne(d => d.Payments).WithMany(p => p.Invoices)
                .HasForeignKey(d => d.PaymentsId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_invoice_payments");

            entity.HasOne(d => d.Users).WithMany(p => p.Invoices)
                .HasForeignKey(d => d.UsersId)
                .OnDelete(DeleteBehavior.ClientSetNull)
